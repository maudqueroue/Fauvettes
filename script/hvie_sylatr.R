...
sylatr <- Fauvettes::new_age(sylatr)
...
# Calcul hvie
hvie_sylatr <- Fauvettes::hvie(sylatr, hvie_sylatr)
N <- dim(hvie_sylatr)[1]
...
hvie_sylatr <- Fauvettes::check_age(hvie_sylatr)
N <- dim(hvie_sylatr)[1]
...
hvie_sylatr <- Fauvettes::check_3(hvie_sylatr, check)
...
hvie_sylatr <- Fauvettes::check_4(sylatr, hvie_sylatr, check)
...
hvie_sylatr <- Fauvettes::supp_ind(hvie_sylatr)
...
hvie_sylatr <- Fauvettes::transient(sylatr, hvie_sylatr)
...
hvie_sylatr <- Fauvettes::cov_ind(sylatr, hvie_sylatr)
...
hvie_sylatr <- Fauvettes::calcul_cov_ind(hvie_sylatr)
